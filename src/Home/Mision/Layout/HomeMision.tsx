  ...
  return (
    <Element name="mision">
        <section className={`relative w-full h-auto flex flex-row  gap-5 p-10 justify-between items-center overflow-hidden `}>
            ...
            <div className="absolute flex flex-row items-center p-5 ">
                {/* imagen */}
                ...
                {/* mision */}
                <motion.div initial={{x:100 , opacity:0}} transition={{duration:1 }} whileInView={{ x:0 , opacity:1}}
                 className="w-full h-[20rem] text-justify flex flex-col gap-4 bg-[#1D2432]/70 justify-center p-2 rounded-xl border-2 border-green-500">
