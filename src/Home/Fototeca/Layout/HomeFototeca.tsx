...
export const HomeFototeca = () => {
  ...
  return (
    <Element name="fototeca">
      ...
      <section className=" bg-gray-950 shadow-2xl shadow-black w-full h-auto flex  flex-col gap-5 md:p-10 justify-between md:items-start items-center overflow-hidden">
        {/* opciones */}
        <motion.div
          initial={{ x: -100, opacity: 0 }}
          transition={{ duration: 1.5 }}
          whileInView={{ x: 0, opacity: 1 }}
          className="w-full flex flex-col md:gap-4"
        >
          <div className="w-full flex flex-row md:gap-5 md:justify-center md:items-center overflow-auto ">
            <div 
        ...
        >
          <div className="w-full h-[35rem] flex flex-col">
